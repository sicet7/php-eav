...
final readonly class HTTPAttributeLoader implements PluginInterface
{
    /**
    ...
    {
        $source->value(HTTPAttributeLoader::class, $this);
        $source->decorate(RouteCollectorInterface::class, function (
            RouteCollectorInterface $routeCollector,
            ContainerInterface $container
        ): RouteCollectorInterface {
            $plugin = $container->get(HTTPAttributeLoader::class);
